...
<div class='main-container'>
    ...
    <!--  contents area start  -->
    <div class="col-lg-12">
        <h4>SGC Auto Installer </h4>
        <?php
        $passed = '';
        $ltext = '';
        if (version_compare(PHP_VERSION, '5.3.9') >= 0) {
            $ltext .= 'Para correr o SGC e necessario 5.3.9 versao do PHP, Your PHP Version is: ' . PHP_VERSION . " Tested <strong>---PASSED---</strong><br/>";
            $passed .= '1';

        } else {
            $ltext .= 'Para correr o SGC e necessario versao do PHP 5.3.9, Your PHP Version is: ' . PHP_VERSION . " Tested <strong>---FAILED---</strong><br/>";
            $passed .= '0';

        }

        if (extension_loaded('PDO')) {
            $ltext .= 'PDO Esta instalado em seu servidor: ' . "Tested <strong>---PASSED---</strong><br/>";
            $passed .= '1';
        } else {
